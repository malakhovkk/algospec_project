...
const Header = () => {
  ...
  const handlePurchaseClick = (e) => {
    ...
    if (location.pathname === '/') {
      // Если уже на главной странице, просто прокручиваем к секции
  ...
  return (
    <header className="algospec">
      <div className="algospec__logo">
        <img className="algospec__img" src={logo} alt="AlgoSpec Logo" />
      </div>
      <ul className="navigation">
        <li className="navigation__item">
          <Link to="/">Что такое AlgoSpec?</Link>
        </li>
        <li className="navigation__item">
          <Link to="/problems">Содержание</Link>
        </li>
        <li className="navigation__item">
